...
class spymer:
	def main(self):
		...
		while i < 1:
			...
			facebook = requests.post('https://m.facebook.com/login/identify/?ctx=recover&c=https%3A%2F%2Fm.facebook.com%2F&multiple_results=0&ars=facebook_login&lwv=100&_rdr', json={'phone': '+' + _phone
